...
const ShowAnswerButton: React.FC<Properties> = ({
  isFlipped,
	onPress,
}) => {
      ...
      <Animated.View
        ...
        <Pressable onPress={onPress}>
								{({ pressed }) => {
									...
									return (
										<View style={[globalStyles.flexGrow1, globalStyles.alignItemsCenter, globalStyles.p16, globalStyles.r16, wrapperBackgroundColorStyle]}>
